...
export class ProfileEditComponent implements OnInit {
    ...
    get born() {
        return this.datePipe.transform(
            this.profileForm.get('bornDate').value,
            'YYYY.MM.dd'
        );
    }
    ...
    submit() {
        ...
        else if (this.modalProperty == 'Photo')
            this.saveImageSource(this.imageSrc);
    ...
    updateSexType() {
        this.userService
            .updateSex(this.sex)
            .then((res) => {
                console.log('updateSexType response: ' + res);
            })
            .catch((err) => {
                console.log(err);
            });
